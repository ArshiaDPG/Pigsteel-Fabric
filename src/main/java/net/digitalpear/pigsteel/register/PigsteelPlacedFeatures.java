...
public class PigsteelPlacedFeatures {
    ...
    public static void bootstrap(Registerable<PlacedFeature> featureRegisterable) {
        ...
        RegistryEntry<ConfiguredFeature<?, ?>> registryEntry = registryEntryLookup.getOrThrow(PigsteelConfiguredFeatures.ORE_PIGSTEEL);
        PlacedFeatures.register(featureRegisterable, ORE_PIGSTEEL, registryEntry, modifiersWithCount(20, HeightRangePlacementModifier.uniform(YOffset.fixed(0), YOffset.fixed(128))));
