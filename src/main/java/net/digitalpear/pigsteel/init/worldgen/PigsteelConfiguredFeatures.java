...
public class PigsteelConfiguredFeatures {
    ...
    public static void bootstrap(Registerable<ConfiguredFeature<?, ?>> featureRegisterable) {
        RuleTest netherStoneRule = new TagMatchRuleTest(BlockTags.BASE_STONE_NETHER);

        ConfiguredFeatures.register(featureRegisterable, ORE_PIGSTEEL, Feature.ORE, new OreFeatureConfig(netherStoneRule, PigsteelBlocks.PORKSLAG.getDefaultState(), 5, 0.5f));
        ConfiguredFeatures.register(featureRegisterable, ORE_PIGSTEEL_EXTRA, Feature.ORE, new OreFeatureConfig(netherStoneRule, PigsteelBlocks.PORKSLAG.getDefaultState(), 9));
    }
